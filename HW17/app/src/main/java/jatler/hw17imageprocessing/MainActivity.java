package jatler.hw17imageprocessing;
...
public class MainActivity extends Activity implements TextureView.SurfaceTextureListener {
    ...
    private void setMyControlListener() {
        rControl.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
        ...
        tControl.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
