/*******************************************************************************
  MPLAB Harmony Application Source File - USB HID from Nick
...
unsigned char data[14];  //buffer reading from IMU
float xl_scaled_x, xl_scaled_y, xl_scaled_z;
...
void APP_Tasks(void) {
    ...
    switch (appData.state) {
        ...
        case APP_STATE_MOUSE_EMULATE:
            ...
            //Code to control mouse cursor below
            ...
            if (!appData.isMouseReportSendBusy) {
                ...
                movement_length++; //movement length position
            }
