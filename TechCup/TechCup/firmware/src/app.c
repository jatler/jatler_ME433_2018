/*******************************************************************************
  MPLAB Harmony Application Source File - CDC from Nick
...
void APP_Initialize(void) {
    ...
    TRISAbits.TRISA4 = 0; //LED as output
    ...
    T5CKRbits.T5CKR = 0b0100; // B9 is read by T5CK - LEFT
    T3CKRbits.T3CKR = 0b0100; // B8 is read by T3CK - RIGHT
